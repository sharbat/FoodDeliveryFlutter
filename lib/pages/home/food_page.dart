  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        //dots
        GetBuilder<PopularProductController>(builder: (popularProsucts) {
          return DotsIndicator(
            dotsCount: popularProsucts.popularProductList.isEmpty
                ? 1
                : popularProsucts.popularProductList.length,
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                margin: const EdgeInsets.only(bottom: 3),
                child: SmallText(text: "Foord pairing"),
              ),
            ],
          ),
        ),
